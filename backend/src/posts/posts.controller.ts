...
export class PostsController {
  ...
  async findAll(
    ...
    console.log(`--- 1. Controller recebendo limit: ${limit}, page: ${page} ---`);
    const result = await this.postsService.findAll(limit, page);
    console.log('--- 2. Service retornou para o Controller ---');
    return result;
  }
  ...
  async findAllPublished() {
    ...
    @IsPublic()
    testePublico() {
    console.log('ROTA DE TESTE PÚBLICO FOI ACESSADA!');
    return { message: 'Esta rota é 100% pública e funcionou!' };
    }
